...
HD_PWD='C:/Xilinx/Projects/Project_Reisis_2021_1/Project_Reisis_2021_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NETWORK_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NETWORK_TOP.tcl
